                ...
                }))
            {
                ...
                try
                {
                    using (WMSDbContext Db = new WMSDbContext())
                    {
                        ...
                        if (receive.InventoryTransactions != null)
                        {
                            ...
                            var realinvengroup = receive.InventoryTransactions.GroupBy(a => new { a.Box, a.Expire, a.Inspect, a.LocIDSys, a.Lot, a.Pallet, a.ItemIDSys })
                                .Select(b => new
                                {
                                    Box = b.Key.Box,
