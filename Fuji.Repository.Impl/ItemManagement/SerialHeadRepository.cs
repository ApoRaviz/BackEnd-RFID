...
{
    public class SerialHeadRepository : IGenericRepository<ImportSerialHead>
    {
        private FujiDbContext Context { get; set; }
        private DbSet<ImportSerialHead> DbSet;

        public SerialHeadRepository()
        {
            this.Context = new FujiDbContext();
            this.DbSet = Context.Set<ImportSerialHead>();
        }
