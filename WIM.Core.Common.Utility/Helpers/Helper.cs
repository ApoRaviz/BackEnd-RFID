...
namespace WIM.Core.Common.Utility.Helpers
{
    ...
    public enum ErrorCode
    {
        ...
        [ErrorMessage("Invalid Parameter in config"), HttpCode(HttpStatusCode.PreconditionFailed)]
        E4113 = 4113,
        ...
        [ErrorMessage("Your Token Timeout!, Cannot POST,PUT,DELETE Please login again."), HttpCode(HttpStatusCode.Unauthorized), Action("A2")]
        E402 = 402,
