...
{
    public class ItemsHeadRepository : IGenericRepository<InboundItemsHead>
    {
        private IsuzuDataContext Context { get; set; }
        private DbSet<InboundItemsHead> DbSet;

        public ItemsHeadRepository()
        {
            this.Context = IsuzuDataContext.Create(); 
